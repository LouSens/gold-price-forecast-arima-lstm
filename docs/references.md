...
IEEE style. The same list, numbered identically, is used in `reports/laporan.md`.

## Domain and forecasting comparisons
...
- "Deep learning for time series forecasting: a survey," *International Journal of Machine Learning and Cybernetics* (Springer), 2025.
- "Financial time series forecasting: a comprehensive review," *Computational Economics* (Springer), 2025.
- "A comparison of the optimized LSTM, XGBOOST and ARIMA in time series forecasting," IEEE Xplore document 9555520.

Verify the full bibliographic details of these three before citing them.
